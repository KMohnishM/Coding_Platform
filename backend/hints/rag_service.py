...
class RAGService:
    ...
    def __init__(self):
        ...
        # Initialize TF-IDF vectorizer for similarity search (if available)
        if SKLEARN_AVAILABLE:
            ...
            self.problem_embeddings = {}
            self.problem_texts = {}
            logger.warning("⚠️ Scikit-learn not available, using fallback similarity methods")
